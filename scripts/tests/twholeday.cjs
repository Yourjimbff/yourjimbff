...
t(/^<div class="fdPanel wdFull dense"><div class="fdGrab"/.test(html) && !/fdFoot/.test(html), 'the sheet stands full height (dense, six things or more), the handle at its top');
