...
eval([multi('var _JT_CAL_RE=new RegExp('), multi('var _JT_PAST_MEAL_RE=new RegExp('),
 ...
 multi('var _JT_ONE_BRAIN_HOLD='),
 multi('var _JT_MEAL_NOUN_RE=new RegExp('), multi('var _JT_DAY_TARGET_RE=new RegExp('),
 multi('var _JT_CAL_ONLY_RE=new RegExp('),
 grab(l=>l.startsWith('function _titleCap(')), grab(l=>l.startsWith('function _jtMealMove(')),
 grab(l=>l.startsWith('function _jtCalendarClaims(')),
...
require('./_guard.cjs')(['_JIM_CARDIO_RE','_JIM_MEALREL2_RE','_JIM_MEALREL_RE','_JIM_BODY_PART','_JIM_SESSION_DAY','_JIM_WO_RE','_JT_CAL_RE','_JT_PAST_MEAL_RE','_JT_SCHED_INTENT_RE','_JT_ONE_BRAIN_HOLD','_JT_MEAL_NOUN_RE','_JT_DAY_TARGET_RE','_JT_CAL_ONLY_RE','_jtMealMove','_jimHarvestSteps','_jimLooksLikeWorkout','_jimMealRelTitle','_jtCalendarClaims','_titleCap'], function(n){ return eval(n); });
