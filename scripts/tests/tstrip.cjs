...
t(_crmLogSumWords({ever:true, since:0, inStrip:3, window:3, streak:3})==='every day since joining (3 of 3) · 3 in a row', 'the words for a new client who has not missed');
t(_crmLogSumWords({ever:true, since:0, inStrip:2, window:3, streak:0})==='2 of 3 days since joining', 'and one who has');
